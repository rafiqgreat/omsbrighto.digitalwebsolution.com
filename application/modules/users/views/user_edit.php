        ...
        <div class="card-header">
          <div class="d-inline-block">
            ...
            <div class="d-inline-block float-right">
              <a href="<?= base_url('users'); ?>" class="btn btn-success"><i class="fa fa-list"></i> <?= trans('users_list') ?></a>
          ...
          <div class="card-body">
           ...
           <?php echo form_open(base_url('users/edit/'.$user['user_id']), 'class="form-horizontal"' )?> 
